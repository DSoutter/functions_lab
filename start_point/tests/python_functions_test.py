...
#   @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self):
    #add test code here
    cube_func = volume_of_cube(4)
    self.assertEqual(64, cube_func)
...
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self):
    ...
    self.assertEqual('OLLEH', reverse_func)

  #Given a value in farenheit, convert this into celsius.
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    #add test code here
    celsius_func = fahrenheit_to_celsius(0)
    self.assertEqual(-17.78, celsius_func)
